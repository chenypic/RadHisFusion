...
### Internal Imports
from datasets.dataset_survival_rad_his import Generic_WSI_Survival_Dataset, Generic_MIL_Survival_Dataset
from utils.file_utils import save_pkl, load_pkl
from utils.core_utils_rad_his import train
...
parser.add_argument('--data_root_dir',   type=str, default='/data/yzhr/04-liver-path/data/shengli_clam_out/', help='Data directory to WSI features (extracted via CLAM')
parser.add_argument('--seed', 			 type=int, default=1, help='Random seed for reproducible experiment (default: 1)')
parser.add_argument('--k', 			     type=int, default=5, help='Number of folds (default: 5)')
parser.add_argument('--k_start',		 type=int, default=-1, help='Start fold (Default: -1, last fold)')
parser.add_argument('--k_end',			 type=int, default=-1, help='End fold (Default: -1, first fold)')
parser.add_argument('--results_dir',     type=str, default='./results_new_2024-11-29-all', help='Results directory (Default: ./results)')
...
parser.add_argument('--gc',              type=int, default=12, help='Gradient Accumulation Step.') #gai
parser.add_argument('--max_epochs',      type=int, default=1000, help='Maximum number of epochs to train (default: 20)')
...
parser.add_argument('--bag_weight',      type=float, default=0.8, help='clam: weight coefficient for bag-level loss (default: 0.7)')
...
if 'survival' in args.task:
	...
	# study_dir = '%sfeatures' % combined_study
	
	study_dir = 'FEATURES'

	dataset = Generic_MIL_Survival_Dataset(
										   csv_path = 'end_table_rfs/traindata.csv',
										   mode = args.mode,
										   ...
										   ignore=[])
	dataset_val = Generic_MIL_Survival_Dataset(
										   csv_path = 'end_table_rfs/valdata.csv',
										   mode = args.mode,
										   apply_sig = args.apply_sig,
										   data_dir= os.path.join(args.data_root_dir, study_dir),
										   shuffle = False, 
	...
	dataset_test = Generic_MIL_Survival_Dataset(
										   csv_path = 'end_table_rfs/testdata.csv',
										   mode = args.mode,
										   apply_sig = args.apply_sig,
										   data_dir= os.path.join(args.data_root_dir, study_dir),
										   shuffle = False, 
