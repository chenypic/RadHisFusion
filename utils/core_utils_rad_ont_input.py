...
from models.model_porpoise_rad_onr_input import PorpoiseMMF, PorpoiseAMIL
...
def train_loop_survival(epoch, model, loader, optimizer, n_classes, writer=None, loss_fn=None, reg_fn=None, lambda_reg=0., gc=16):   
    ...
    for batch_idx, (data_WSI, rad_A,rad_V, rad_A_seg,rad_V_seg,y_disc, event_time, censor,rad_all) in enumerate(loader):  
        ...
        # backward pass
        loss = 0.2*loss / gc + loss_reg+0.8* loss_ /gc
        loss.backward()
